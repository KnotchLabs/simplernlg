...
describe SimplerNLG::NLG do
  ...
  it "accept unicode in direct notation" do
    ...
    nlg.render("Björn has problems pronouncing the German letter ß"
    ).should eq "Björn has problems pronouncing the German letter ß."
  end 

  it "accept multibyte unicode via \\u and direct mix" do
    pending("unicode support requires UTF8 as default JVM encoding") unless @@jvm_encoding=="UTF-8"
    nlg.render("S\u00F6ren Ånstrom is not skilled enough to write the Khmer sign '៚'"
    ).should eq "S\u00F6ren Ånstrom is not skilled enough to write the Khmer sign '៚'."
  end 
  ...
  it "produce simple sentences from subject-verb-object hash input" do
    nlg.render(
                ...
                :verb=>"fear", 
                :object=>"the monkey"
              ).should eq "George fears the monkey."
  end
  ...
  it "produce simple sentences from SVO hash input" do
    nlg.render(
                ...
                :v=>"hate", 
                :o=>"the donkey"
              ).should eq "Kate hates the donkey."
  end
  ...
  it "correctly handle particles in verb string" do
    nlg.render(
                ...
                :v=>"pick up", 
                :o=>"a coin"
              ).should eq "John picks up a coin."
  end 
  ...
  it "handle past tense" do
    nlg.render(
                ...
                :o=>"several poems", 
                :tense=>:past
              ).should eq "Dave learned several poems."
  end
  ...
  it "handle future tense" do
    nlg.render(
                ...
                :o=>"a way", 
                :tense=>:future
              ).should eq "Mike will find a way."
  end
  ...
  it "handle negation" do
    nlg.render(
                ...
                :o=>"more lessons", 
                :negation=>true
              ).should eq "Jennifer does not require more lessons."
  end
  ...
  it "handle negation as 'negated' and also in combination with altered tense" do
    nlg.render(
                ...
                :negation=>true, 
                :tense=>:past
              ).should eq "Dan did not catch the train."
  end
  ...
  it "handle binary questions" do
    nlg.render(
                ...
                :o=>"his father", 
                :question=>:binary
              ).should eq "Does Joshua know his father?"
  end
  ...
  it "handle binary interrogations as 'yes_no' in conjunction with altered tense" do
    nlg.render(
                ...
                :v=>"go", 
                :o=>"to town", 
                :interrogation=>:yes_no, 
                :tense=>:past
              ).should eq "Did Dimitry go to town?"
  end
  ...
  it "handle negated 'who' questions on the indirect object" do
    nlg.render(
                ...
                :v=>"bring", 
                :o=>"the wine", 
                :q=>:who_indirect_object, 
                :negated=>:true
              ).should eq "Who does James bring the wine to?"
  end
  ...
  it "handle 'where' questions for the past tense" do
    nlg.render(
                ...
                :interrogation=>:where, 
                :tense=>:past
              ).should eq "Where did Susan walk?"
  end
  ...
  it "handle 'what_subject' questions" do
    nlg.render(
                ...
                :v=>"defeat", 
                :o=>"rock", 
                :interrogation=>:what_subject
              ).should eq "What defeats rock?"
  end
  ...
  it "handle onject-centic 'what' questions in future tense" do
    nlg.render(
                ...
                :v=>"play", 
                :o=>"golf" , 
                :interrogation=>:what_object, 
                :tense=>:future
              ).should eq "What will Gertrude play?"
  end
  ...
  it "handle 'why' questions" do
    nlg.render(
                ...
                :interrogation=>:why, 
                :tense=>:past
              ).should eq "Why did the chicken cross the road?"
  end
  ...
  it "produce passive voice" do
   nlg.render(
              :s=>"Michael", 
                ...
                :passive=>true, 
                :tense=>:past
              ).should eq "The speech was given by Michael."
  end
  ...
  it "be able to produce negated passive questions in future tense" do
   nlg.render(
              :s=>"Jonathan", 
                ...
                :tense=>:future, 
                :negation=>true
              ).should eq "Why will Bert not be respected by Jonathan?"
  end
  ...
  it "accept a single complement" do
    nlg.render(
                ...
                :v=>"hit", 
                :o=>"Einstein", 
                :complement=>"with a ruler"
              ).should eq "Newton hits Einstein with a ruler."
  end
  ...
  it "accept multiple complements" do
    nlg.render(
                ...
                :v=>"take", 
                :o=>"Olivia", 
                :complements=>["to a party","for entertainment purposes"], 
                :tense=>:past
              ).should eq "Daniel took Olivia to a party for entertainment purposes."
  end
  ...
  it "accept multiple complements via 'c' shortcut and form past tense questions with them" do
    nlg.render(
                :s=>"Steven", 
                :v=>"drink", 
                :c=>["too much","too often"], 
                :tense=>:past, 
                :q=>:who_subject
              ).should eq "Who drank too much too often?"
  end
  ...
  #               :s=>"Steven", 
  #               :v=>"drink", 
  #               :pp => SimplerNLG::NLG::Container.new(:modifier,"Nepomuk","crazy"), 
  #               :tense=>:past, 
  #               :q=>:who_subject
  #             ).should eq "Who drank Nepomuk crazy?"
  ...
  it "allow subject modifiers" do
    nlg.render(
                ...
                :v=>"like", 
                :o=>"chess"
              ).should eq "Holy Paul likes chess."
  end

  it "allow subject modifiers from within an ugly notation" do
    nlg.render{phrase(:s=>nlg.mod("Nepomuk","crazy"), 
                :v=>"steal", 
                :o=>"the money", 
                :tense=>:past)}.should eq "Crazy Nepomuk stole the money."
  end

  it "allow subject modifiers from within an even worse notation" do
    nlg.render{phrase(:s=>SimplerNLG::NLG::Container.new(:modifier,"Nepomuk","crazy"), 
                :v=>"steal", 
                :o=>"the money", 
                :tense=>:past)}.should eq "Crazy Nepomuk stole the money."
  end
  ...
  it "allow subject modifiers from within blocks" do
    nlg.render{phrase(:s=>mod("Karen","lazy"), 
                :v=>mod("sleep","long"), 
                :tense=>:past)}.should eq "Lazy Karen slept long."
  end

  it "allow pre and post modifiers and allow for symbols as modifier" do
    nlg.render{phrase(:s=>pre_mod("Monica","beautiful"), 
                :v=>post_mod("go","immediately"), 
                :o=>pre_mod("France",:to), 
                :tense=>:past)}.should eq "Beautiful Monica went immediately to France."
  end

  it "mix modifiers and questions in past tense" do 
    nlg.render{phrase(:s=>pre_mod("Nathanael","smart"), 
                :v=>pre_mod("search","surely"),
                :tense=>:past, 
                :q=>:what_object)}.should eq "What did smart Nathanael surely search?"
  end

  it "mix modifiers and questions in present tense" do 
    nlg.render{phrase(:s=>pre_mod("Gordon","dumb"), 
                :v=>pre_mod("assume","falsely"), 
                :tense=>:present, 
                :q=>:what_object)}.should eq "What does dumb Gordon falsely assume?"
  end
  ...
  #               :v=>pre_mod("search","surely"), 
  #               :tense=>:future, 
  #               :q=>:what_object)}.should eq "What will smart Nathanael surely search?"
  # end

  it "modifiers have no influence on interrogation words" do
    nlg.render{phrase(:s=>mod("Someone","brown-eyed"), 
                :v=>"laugh", 
                :q=>:who)}.should eq "Who laughes?"
  end
  ...
  it "handle and-conjunctions as simple arrays in subject and object" do
    nlg.render(
                ...
                :v=>"meet", 
                :o=>["Olga","Roswitha"]
              ).should eq "Jane and Martha meet Olga and Roswitha." 
  end

  it "handle and-conjunctions of more than one constituent" do
    nlg.render(
                :s=>["Netty","Josephine","Lindsey"], 
                :v=>"chat"
              ).should eq "Netty, Josephine and Lindsey chat."  
  end

  it "handle and-conjunctions of modified words in past tense" do
    nlg.render{phrase(:s=>[pre_mod("Lana","suspicious"),post_mod("Adam","the coward")], 
                :v=>"disagree", 
                :tense=>:past)}.should eq "Suspicious Lana and Adam the coward disagreed."  
  end

  it "handle explicitly declared and-conjunctions" do
    nlg.render(
                :s=>[:and, "Siegfried","Brunhild"], 
                :v=>"argue"
              ).should eq "Siegfried and Brunhild argue." 
  end
  ...
  it "handle explicitly declared or-conjunctions" do
    nlg.render(
                ...
                :o=>"the match", 
                :t=>"future"
              ).should eq "Titus or Jorge will win the match." 
  end

  # it "handle explicitly declared neither-nor-conjunctions" do
  #  nlg.render(
  #           :s=>[:neither_nor, "Sam","Max"], 
  #               :v=>"understand", 
  #               :o=>"anything", t:"past"
  #             ).should eq "Neither Sam nor Max did understand anything." 
  # end
  ...
  it "handle explicitly declared or-conjunctions in negated sentences in future tense" do
    nlg.render(
                :s=>["David","Jim"], 
                :v=>"choose", 
                :o=>[:or,"chocolate","jelly beans"], 
                :tense=>:future, 
                :negation=>true
              ).should eq "David and Jim will not choose chocolate or jelly beans." 
  end
  ...
  it "can handle nouns as Hashes" do
    nlg.render{phrase(s: {:determiner => "the", :noun => "moon"} )}.should eq "The moon."
  end
  it "can handle recursive nouns as Hashes" do
    nlg.render{ phrase(s: {:specifier => { :determiner => "the", :noun => "moon" },  :noun => "craters"} ) }.should eq "The moon's craters."
  end
